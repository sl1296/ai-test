...
def get_cnn(r_len):
    model = Sequential()
    model.add(Convolution2D(16, (3, 3), activation='selu', input_shape=(110, 110, 1)))  # 54*54
    model.add(MaxPooling2D((2, 2)))  # 52*52
    model.add(BatchNormalization())
    model.add(Convolution2D(16, (3, 3), activation='selu'))  # 54*54
    model.add(MaxPooling2D((2, 2)))  # 52*52
    model.add(BatchNormalization())
    model.add(Convolution2D(32, (3, 3), activation='selu'))  # 26*26
    model.add(MaxPooling2D((2, 2)))  # 24*24
    model.add(BatchNormalization())
    model.add(Convolution2D(64, (3, 3), activation='selu'))  # 12*12
    model.add(MaxPooling2D((2, 2)))  # 10*10
    model.add(BatchNormalization())
    model.add(Flatten())  # 5*5
    model.add(Dense(200, activation='selu'))
    model.add(BatchNormalization())
    model.add(Dense(r_len, activation='selu'))
