...
def get_cnn(r_len):
    ...
    model.add(Convolution2D(64, (3, 3), activation='selu'))  # 54*54
    model.add(MaxPooling2D((2, 2)))  # 52*52
    model.add(BatchNormalization())
    model.add(Convolution2D(64, (3, 3), activation='selu'))  # 26*26
