...
def get_cnn(r_len):
    model = Sequential()
    model.add(Convolution2D(15, (3, 3), activation='relu', input_shape=(54, 54, 1)))  # 54*54
...
def main():
    ...
    if load:
        model.load_weights('cnn-FF2-5.h5')
    ...
    for xx in range(0,1001):
        ...
        model.save_weights('cnn-FF2-' + str(xx) + '.h5')
